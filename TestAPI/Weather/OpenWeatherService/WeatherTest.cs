...
namespace TestAPI
{
    public class WeatherTests
    {
        ...
        {
            mockHttp.When(url).Respond("application/json", "");
        ...
        public void Check_ParamNot_Exception()
        {
            ...
            mockHttp.When(url).Respond("application/json", "{'name' : 'Test McGee'}");
        ...
        {
            mockHttp.When(url).Respond("application/json", "{'name' : 'not'}");
        ...
        {
            mockHttp.When(url).Respond(HttpStatusCode.ServiceUnavailable);
        ...
        public void Http_Request_Success()
        {
            ...
            mockHttp.When(url).Respond("application/json", responseJson);
