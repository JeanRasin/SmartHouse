# ⚙️ REST API
**ASP.NET Core REST API** - Back-end проект для реализации API системы умный дом. Реализовано в проекте [API\SmartHouseAPI](https://github.com/JeanRasin/SmartHouse/tree/master/API/SmartHouseAPI). Использует [Swagger](https://github.com/domaindrivendev/Swashbuckle.AspNetCore) автоматическую систему документирования API. Открыть можно по адресу `http://localhost:55673/api/docs/index.html`, JSON описание `http://localhost:55673/api/docs/v1/swagger.json`.
